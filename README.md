...
- При закрытии тикета сотрудником пользователь получает уведомление в боте
- Команды группы: `/active`, `/in_progress`, `/closed`, `/my`, `/chat_<id_тикета>`, `/close_ticket_<id_тикета>`
